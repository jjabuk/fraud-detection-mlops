...
| Workbench                            | The analysis half is an R package in [`analysis/`](../analysis/README.md) with its own `targets` graph and `testthat` suite; it runs locally in minutes against a parquet export. A managed notebook would host that same code at an hourly rate, and would not make any of it more reproducible than a lockfile already does.                                                                                                                                                                                                                                                  |
